                    ...
                    await global::Roboflow.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Roboflow.WorkflowValidationStatus.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Roboflow.WorkflowValidationStatus.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
