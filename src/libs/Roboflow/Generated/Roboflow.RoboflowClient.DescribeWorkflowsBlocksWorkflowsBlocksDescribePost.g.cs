            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Roboflow.WorkflowsBlocksDescription.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Roboflow.WorkflowsBlocksDescription.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
