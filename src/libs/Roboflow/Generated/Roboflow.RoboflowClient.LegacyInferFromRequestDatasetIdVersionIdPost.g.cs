    ...
    public partial class RoboflowClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            __pathBuilder
                ...
                .AddOptionalParameter("disable_preproc_auto_orient", disablePreprocAutoOrient?.ToString())
                .AddOptionalParameter("disable_preproc_contrast", disablePreprocContrast?.ToString())
                .AddOptionalParameter("disable_preproc_grayscale", disablePreprocGrayscale?.ToString())
                .AddOptionalParameter("disable_preproc_static_crop", disablePreprocStaticCrop?.ToString())
                .AddOptionalParameter("disable_active_learning", disableActiveLearning?.ToString())
