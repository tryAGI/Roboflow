...
namespace Roboflow
{
    public partial class RoboflowClient
    {
        ...
        private static readonly global::Roboflow.EndPointSecurityRequirement s_PpOcrRetrieveTextOcrPpOcrPostSecurityRequirement0 =
        ...
        private static readonly global::Roboflow.EndPointSecurityRequirement[] s_PpOcrRetrieveTextOcrPpOcrPostSecurityRequirements =
            new global::Roboflow.EndPointSecurityRequirement[]
            {                s_PpOcrRetrieveTextOcrPpOcrPostSecurityRequirement0,
            };
        partial void PreparePpOcrRetrieveTextOcrPpOcrPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            bool? countinference,
            ref string? serviceSecret,
            global::Roboflow.PPOCRInferenceRequest request);
        partial void PreparePpOcrRetrieveTextOcrPpOcrPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? countinference,
            string? serviceSecret,
            global::Roboflow.PPOCRInferenceRequest request);
        partial void ProcessPpOcrRetrieveTextOcrPpOcrPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPpOcrRetrieveTextOcrPpOcrPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Roboflow.OCRInferenceResponse> PpOcrRetrieveTextOcrPpOcrPostAsync(
        ...
        {
            var __response = await PpOcrRetrieveTextOcrPpOcrPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Roboflow.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Roboflow.AutoSDKHttpResponse<global::Roboflow.OCRInferenceResponse>> PpOcrRetrieveTextOcrPpOcrPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePpOcrRetrieveTextOcrPpOcrPostArguments(
            ...
            var __authorizations = global::Roboflow.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PpOcrRetrieveTextOcrPpOcrPostSecurityRequirements,
                operationName: "PpOcrRetrieveTextOcrPpOcrPostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePpOcrRetrieveTextOcrPpOcrPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Roboflow.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Roboflow.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PpOcrRetrieveTextOcrPpOcrPost",
                                methodName: "PpOcrRetrieveTextOcrPpOcrPostAsync",
                                pathTemplate: "\"/ocr/pp-ocr\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPpOcrRetrieveTextOcrPpOcrPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Roboflow.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPpOcrRetrieveTextOcrPpOcrPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Roboflow.OCRInferenceResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Roboflow.AutoSDKHttpResponse<global::Roboflow.OCRInferenceResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Roboflow.OCRInferenceResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Roboflow.OCRInferenceResponse> PpOcrRetrieveTextOcrPpOcrPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Roboflow.PPOCRInferenceRequest
            {
                Id = id,
                ApiKey = apiKey,
                ...
                PpOcrVersionId = ppOcrVersionId,
                ModelId = modelId,
            };

            return await PpOcrRetrieveTextOcrPpOcrPostAsync(
                countinference: countinference,
                serviceSecret: serviceSecret,
                request: __request,
                requestOptions: requestOptions,
